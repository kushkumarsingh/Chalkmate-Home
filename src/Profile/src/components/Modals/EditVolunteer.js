                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <p className={styles.modal_heading}>Organization</p>
                        ...
                        >
                            ...
                            <p className={styles.modal_heading}>Role</p>
                            <input className={styles.modal_para} type="text" placeholder="Ex : Write something about yourself"
                                style={{
                                    border: '1px solid #5555555A',
                                    padding: 10,
                    ...
                    >
                        ...
                        <p className={styles.modal_heading}>Cause*</p>
                        <input className={styles.modal_para} type="text" placeholder="Ex : Write something about yourself"
                            style={{
                                border: '1px solid #5555555A',
                                padding: 10,
                    ...
                    >
                        ...
                        <textarea className={styles.modal_para} id={styles.textarea} cols={60} rows={10} placeholder="Ex : Write something about yourself"
                            style={{
                                border: '1px solid #5555555A',
                                padding: 10,
                                fontSize: 15,
