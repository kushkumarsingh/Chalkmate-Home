...
export default class InterestsFeed extends React.Component {
    ...
    state = {
        ...
        featuredImage: ["Image/dummy/maths.png", "Image/dummy/physics.png", "Image/dummy/social-studies.png", "Image/dummy/history.png"],
        featuredName: ["Maths", "Physics", "Social Studies", "History"]
    }
    ...
    render() {
        return (
            <div>
                ...
                {
                    this.state.edit ?
                        <Modal card={<EditInterests
                            title="Edit Interests Post"
