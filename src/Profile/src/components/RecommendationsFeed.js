                    ...
                    >
                        ...
                        >
                            <div class="icon-container">
                                <img class="inner-icon" src="Image/Chalkmate_Recommendation.svg" alt=" " />
                            </div>
                            <div>
                                <p class="icon-text" >Recommendations</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div style={{ borderBottom: '1px solid #5555555A', paddingBottom: 15 }}>
                            <div style={{ display: 'flex' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                    ...
                                    <div>
                                        <p class="section-title">Andrew Saunders <br /><span class="followers">global head of entrainment & culture marketing.</span></p>
